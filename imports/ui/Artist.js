...
export default class Artist extends Component {
	...
	render() {
    	...
    	for (var i = 0; i < this.state.related_artists.length; i += 1) {
      		related_artists.push(<Artist key={this.state.related_artists[i]['id']} artist={this.state.related_artists[i]} summary={true} />);
    	};
    	...
    	if(!this.props.summary)
			...
			return (
				<div className="artist-profile-summary-container col-md-12">
					...
					<span> <b> {this.props.artist.name ? this.props.artist.name + "\n" : ''} &nbsp; </b></span>
